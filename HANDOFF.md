...
_Last updated for the **hand-modeled-ship era** (branch `claude/focused-meitner-73h1gk`,
HEAD `af3a3d9`). Working tree is clean; everything described below is committed. This
